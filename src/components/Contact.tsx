          ...
          <div className="bg-gradient-subtle rounded-2xl p-8 border border-border flex flex-col">
            ...
            <div className="relative flex-1">
              <div className="h-full rounded-lg overflow-hidden border border-border shadow-elegant bg-card" style={{ minHeight: '400px' }}>
                <iframe
                  src="https://calendar.google.com/calendar/embed?height=600&wkst=1&ctz=Europe%2FWarsaw&bgcolor=%23ffffff&src=Y19iMDgxYTFlNTY3MGY5MDVmZjNlMGVlOGNiODFlOTMyNGFhM2NlOGJhYWYxYjYyODVlM2QyNmVhMDRjYmI2ODgyQGdyb3VwLmNhbGVuZGFyLmdvb2dsZS5jb20&color=%23D50000&mode=AGENDA"
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowFullScreen
