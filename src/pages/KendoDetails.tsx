            ...
            <CardContent className="space-y-6">
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-foreground">Na pierwszy trening potrzebujesz jedynie zgody rodzica/opiekuna (w przypadku osób niepełnoletnich). Resztę dokumentów, takich jak <Link to="/o-nas#declaration-section" className="text-crimson hover:underline">deklaracja członkowska</Link> i zaświadczenie od lekarza sportowego, możesz dostarczyć w ciągu kilku kolejnych tygodni.</p>
                </div>
