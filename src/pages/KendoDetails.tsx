      ...
      <nav className="bg-background/95 backdrop-blur-md border-b border-border shadow-elegant sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <h1 className="text-xl font-zen font-medium text-soft-white">Kendo</h1>
        ...
        <div className="max-w-4xl mx-auto space-y-12">
          ...
          <Card className="border-border hover:border-crimson transition-smooth">
            ...
            <CardContent className="space-y-6">
              <div>
                <h4 className="font-zen font-medium text-accent mb-3">Czego potrzebujesz żeby zacząć trenować Kendo:</h4>
              ...
              <div>
                ...
                <p className="text-foreground">
                  Kendo - grupy otwarte są cały rok. Przed przyjściem skontaktuj się z nami.
                  Zalecamy również zapoznać się z podstawowymi zasadami w sekcji FAQ poniżej.
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border-border hover:border-crimson transition-smooth">
            ...
            <CardContent className="space-y-6">
              <div className="space-y-4">
                <div>
                  <h4 className="font-zen font-medium text-accent mb-2">1. Chcę zacząć trenować Kendo. Jak i kiedy mogę dołączyć?</h4>
                  <p className="text-foreground">Nabór do grup początkujących Kendo odbywa się w trybie ciągłym. Wystarczy, że przyjdziesz na trening w wybranym przez Ciebie terminie.</p>
                </div>
                
                <div>
                  <h4 className="font-zen font-medium text-accent mb-2">2. Jakie dokumenty są potrzebne?</h4>
                  <p className="text-foreground">Na pierwszy trening potrzebujesz jedynie zgody rodzica/opiekuna (w przypadku osób niepełnoletnich). Resztę dokumentów, takich jak <Link to="/about-us#declaration-section" className="text-crimson hover:underline">deklaracja członkowska</Link> i zaświadczenie od lekarza sportowego, możesz dostarczyć w ciągu kilku kolejnych tygodni.</p>
                </div>
                
                <div>
                  <h4 className="font-zen font-medium text-accent mb-2">3. Co muszę mieć na pierwszy trening?</h4>
                  <p className="text-foreground">Na początek wystarczy Ci strój sportowy (koszulka i spodnie dresowe) oraz dobre chęci. Przez pierwszy miesiąc nie musisz martwić się o sprzęt – klub udostępnia miecz treningowy (shinai) bezpłatnie.</p>
                </div>
                
                <div>
                  <h4 className="font-zen font-medium text-accent mb-2">4. Czy muszę kupić własny miecz?</h4>
                  <p className="text-foreground">Tak, po pierwszym miesiącu treningów powinieneś zaopatrzyć się we własny miecz treningowy (shinai).</p>
                </div>
                
                <div>
                  <h4 className="font-zen font-medium text-accent mb-2">5. Słyszałem, że Kendo to drogie hobby. Czy to prawda?</h4>
                  <div className="text-foreground space-y-2">
                    <p>Kendo nie jest tak drogie, jak mogłoby się wydawać!</p>
                    <ul className="list-disc list-inside ml-4 space-y-1">
                      <li><strong>Sprzęt początkowy:</strong> Na początku potrzebujesz tylko stroju sportowego, a miecz dostaniesz w klubie. Później kupisz własne shinai za około 100 zł, które wystarczy na około rok.</li>
                      <li><strong>Strój do Kendo:</strong> Tradycyjny strój (keiko-gi i hakama) to wydatek rzędu 250-300 zł, ale nie jest on wymagany na początku. Kupuje się go zazwyczaj po kilku miesiącach treningów, a jeden komplet wystarcza na kilka lat.</li>
                      <li><strong>Zbroja (bogu):</strong> Gdy opanujesz podstawy, klub wypożyczy Ci zbroję na treningi. Nie musisz jej kupować na własność!</li>
                    </ul>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <p className="text-foreground">Nie ma żadnych limitów wiekowych! W Kendo może trenować każdy, niezależnie od wieku. To świetny sposób na poprawę kondycji, kształtowanie charakteru i przełamywanie własnych słabości.</p>
                </div>
                
                <div>
                  <h4 className="font-zen font-medium text-accent mb-2">7. Miałem kiedyś kontuzję. Czy mogę trenować Kendo?</h4>
                  ...
                  <div className="overflow-x-auto">
                    <table className="w-full border-collapse border border-border">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td className="border border-border p-3">Opłata za wynajem bogu (zbroja)</td>
                          <td className="border border-border p-3">Co miesiąc</td>
                          <td className="border border-border p-3">15 zł</td>
                        </tr>
                        <tr>
